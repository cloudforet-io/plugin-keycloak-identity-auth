...
class TestOAuth(TestCase):
    ...
    def test_login(self):
        ...
        user_info = self.identity.Auth.login({'options': OPTIONS, 'secret_data': credentials,
                                              'schema': SCHEMA, 'user_credentials': user_credentials})
    ...
    def test_find_user_id(self):
        ...
        users_info = self.identity.Auth.find({'options': OPTIONS, 'secret_data': credentials,
                                              'schema': SCHEMA, 'user_id': user_id})
